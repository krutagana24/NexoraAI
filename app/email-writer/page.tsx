      ...
      <div className="flex-1 pt-20 pb-4 px-4 flex flex-col max-w-4xl mx-auto w-full">
        ...
        {messages.length === 0 ? (
          <div className="flex-1 flex flex-col items-center justify-center">
            <h1 className={`text-3xl md:text-4xl font-semibold mb-4 text-center ${isLight ? "text-gray-900" : "text-white"}`}>What email do you want to write?</h1>
            <p className={`text-center ${isLight ? "text-gray-600" : "text-gray-400"}`}>Describe your email and I'll write it for you</p>
          </div>
        ) : (
