      ...
      <div className="flex-1 pt-20 pb-4 px-4 flex flex-col max-w-4xl mx-auto w-full">
        ...
        {messages.length === 0 ? (
          <div className="flex-1 flex flex-col items-center justify-center">
            <h1 className="text-3xl md:text-4xl font-semibold text-white mb-4 text-center">What email do you want to write?</h1>
            <p className="text-gray-400 text-center">Describe your email and I'll write it for you</p>
          </div>
        ) : (
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={`p-2 rounded-full transition ${
                  prompt.trim() ? "bg-[#5865F2] text-white hover:bg-[#4752c4]" : "bg-[#1a2744] text-gray-600"
